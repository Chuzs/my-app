      ...
      <Col className='main-menu' xs={24} sm={24} md={24} lg={6} xl={4} xxl={3}>
        <section className="main-menu-inner">
          <Menu mode="inline" defaultOpenKeys={[pathname[1]]} defaultSelectedKeys={[pathname[2] ? pathname[2] : "/"]}>
            ...
            <SubMenu key="base" title={<span><Icon type="user" />坐席基本功能</span>} >
              ...
              <Menu.Item key="setagentautoenteridle"><Link to="/ccacs/setagentautoenteridle">自动进入空闲</Link></Menu.Item>
              <Menu.Item key="resetagentskills"><Link to="/ccbms/resetagentskills">批量重设技能队列</Link></Menu.Item>
            </SubMenu>
            <SubMenu key="call" title={<span><Icon type="user" />坐席呼叫处理能力</span>} >
              ...
              <Menu.Item key="makecall"><Link to="/ccacs/makecall">外呼(新交互)</Link></Menu.Item>
              <Menu.Item key="confirmmessagepush"><Link to="/ccacs/confirmmessagepush">确认IM登录成功是否允许消息推送</Link></Menu.Item>
            </SubMenu>
            <SubMenu key="inspection" title={<span><Icon type="user" />质检功能</span>}>
            ...
            <SubMenu key="query" title={<span><Icon type="laptop" />查询接口</span>} >
            ...
            <SubMenu key="ccbcs" title={<span> <Icon type="notification" />同步工号和技能</span>} >
            ...
            <SubMenu key="callOut" title={<span> <Icon type="notification" />外呼接口</span>} >

            </SubMenu>
            <SubMenu key="recoder" title={<span> <Icon type="notification" />录音调听</span>} >
              <Menu.Item key="skilllist"><Link to="/ccbcs/skilllist">查询录音</Link></Menu.Item>
              <Menu.Item key="queryallskills"><Link to="/ccbcs/queryallskills">下载录音</Link></Menu.Item>
            </SubMenu>
          </Menu>
        </section>
      </Col>
