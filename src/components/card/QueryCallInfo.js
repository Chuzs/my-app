...
class QueryCallInfo extends React.Component {
  componentDidMount() {
  ...
  send = () => {
    ...
    postMsg(this.props, this.props.form.getFieldsValue(), "/ccacs/ws/query/callinfo")
  }
  render() {
    const { getFieldDecorator } = this.props.form;
    return (
      <Tabs defaultActiveKey="1">
        <TabPane tab="查询呼叫信息" key="1">
          <Form {...formItemLayout}>
...
const QueryCallInfoCard = Form.create({ onValuesChange })(QueryCallInfo);
export default QueryCallInfoCard